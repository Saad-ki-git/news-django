        ...
        <div>
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                    ...
                    <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">Explore the world of marketing and security with us.Know what they do and know what you have to do.Join US!</p>
                </div>
                <div style={{display:"flex",justifyContent:"center"}} className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4">
